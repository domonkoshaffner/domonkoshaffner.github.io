...
export const blackHole = {
  singularity: {
    title: 'Approaching the singularity.',
    description: 'From gravitational collapse to the emergence of superintelligence.',
  },
  note: 'Artistic interpretation. Light paths and motion are simplified.',
  credit: {
